...
def generate_and_analyze_strings(size):
    ...
    # Extract counts and compute ratios (unchanged)
    ...
    if 'Baseline_Not_Synthesized Count' in counts:
        ...
        if BNS_count > 0:
            ...
            print(f"Warning: Baseline_Not_Synthesized Count is {BNS_count}, which is not positive. Unable to compute log.")
    else:
    ...
    if 'Not_Baseline_Synthesized_Count' in counts:
        ...
        if NBS_count > 0:
            ...
            print(f"Warning: Not_Baseline_Synthesized_Count is {NBS_count}, which is not positive. Unable to compute log.")
    else:
